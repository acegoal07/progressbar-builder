 ...
 */
module.exports = TimeStampBar = async({posTimeStamp = null, durTimeStamp = null, size = 40, line = "▢", slider = "▣", hideInfo = false, percentage = false}) => {
   // Error messages
   ...
   // Bar output
   const barInfo = !percentage ? (posTimeStamp+' / '+durTimeStamp) : `${position * 100}%`;
   return `${!hideInfo ? barInfo : ''}`+'\r'+'['+progressText+emptyProgressText+']';
 };